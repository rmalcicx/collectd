...
=head2 Plugin C<mcelogmon>

The C<mcelogmon plugin> uses mcelog to retrieve machine check errors, etc.

By default mcelogmon connects to B<"/var/run/mcelog-client"> to check if the
